          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-accent-dark/40 mb-6 max-w-md mx-auto">
                Connect your Algorand wallet to start trading perpetual futures
              ...
              <div className="space-y-2">
                {tradePairs.map((pair) => (
                  ...
                  >
                    ...
                    <span className="font-medium text-accent-dark text-sm">
                      {pair.name}
                    </span>
                    <svg
                      className="w-4 h-4 text-accent-dark/30 ml-auto"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
